...
JumpStack.Block = function(state, x, y, data) {
    ...
    if(this.direction){
        ...
        this.blockMove.to({x: this.game.world.centerX }, this.state.DEFAULT_SPEED)
        .onComplete.add(() => this.state.createMovingBlock(), this.state);
...
JumpStack.Block.prototype.reset = function(x, y, data){
    this.direction = data.dir || 0;
    Phaser.Sprite.prototype.reset.call(this, x, y, data.asset, data.frame);
