...
Match3.Block = function(state, x, y, data) {
  ...
  this.animations.add('top', [84, 71, 45, 32, 19, 19, 31, 57, 109, 148, 148, 148, 109, 71, 45, 45, 58, 71, 97, 110, 110, 97, 84, 70, 57, 57, 57, 70, 70, 70], 30, false);

  this.animations.add('bottom', [84, 96, 109, 122, 122, 109, 58, 19, 6, 6, 58, 97, 110, 110, 84, 58, 58, 58, 71, 84, 84, 84, 84, 71, 71, 71, 71, 71, 71, 84], 30, false);

  this.animations.add('left', [84, 72, 74, 75, 75, 76, 75, 72, 55, 52, 52, 52, 67, 70, 85, 86, 85, 85, 84, 83, 83, 83, 70, 70, 71, 71, 71, 71, 71, 71], 30, false);

  this.animations.add('right', [84, 70, 69, 68, 67, 54, 54, 54, 69, 72, 75, 77, 78, 77, 76, 73, 70, 56, 56, 56, 69, 70, 84, 84, 84, 84, 84, 84, 84, 84], 30, false);
